		...
		// Main.
			...
			// Touch gestures.
				_.$main
					...
					// Feature to switch between the sections thumbnails and villa-info
					$(document).ready(function() {
						// Initially show the thumbnails section
						$('#villa-info').hide();
					
						// Function to switch between sections
						function switchSection(showThumbnails) {
							if (showThumbnails) {
								$('#thumbnails').show();
								$('#villa-info').hide();
							} else {
						...
						// Event handler for showing thumbnails section
						$('#showThumbnails').on('click', function(event) {
							event.preventDefault();
							switchSection(true);
						});
					
						// Event handler for showing villa info section
						$('#showVillaInfo').on('click', function(event) {
							event.preventDefault();
							switchSection(false);
						});
					});
